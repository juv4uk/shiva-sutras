...
| `L-002` | Доступний незалежний, достовірний лінгвістичний корпус (Provenance). | Kāśikā / Aṣṭādhyāyī texts. | `RESOLVED` | GRETIL `jvkasipu.htm` (Sharma ed.) + `panini_u.htm` (Baums), manifest + sha256; 3951 sūtras parsed. Cross-witness diff (sequence alignment): 1891 AGREES / 2013 VARIANTS / 22 CONFLICTS (preliminary: 9 GENUINE) / 57 MISSING. | - | `L-000` (Direct Scrape) |
