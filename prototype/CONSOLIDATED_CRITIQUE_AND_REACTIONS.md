...
9. **Authority Boundary:** `shiva-sutras/prototype/` — це експериментальна референсна лабораторія, а не директивна влада над репозиторіями CML, my-lisp чи FPGA.
...
## ЧАСТИНА 3: ОФІЦІЙНА РЕЗОЛУЦІЯ ECOSYSTEM LEAD
